            ...
            <button
              ...
              onClick={async () => {
                ...
                await generatePatientReport({
                  ...
                  latestScale: scaleMeasurements[0],
                  latestManual: manualMeasurements[0],
                  history,
                  scaleHistoryFull: scaleMeasurements.map(m => ({
                    timestamp: m.timestamp,
                    weight: Number(m.weight),
                    bmi: m.bmi != null ? Number(m.bmi) : undefined,
                    body_fat_percent: m.body_fat_percent != null ? Number(m.body_fat_percent) : undefined,
                    muscle_mass_percent_total: m.muscle_mass_percent_total != null ? Number(m.muscle_mass_percent_total) : undefined,
                    water_percent: m.water_percent != null ? Number(m.water_percent) : undefined,
                    visceral_fat_rating: m.visceral_fat_rating != null ? Number(m.visceral_fat_rating) : undefined,
                    bone_mass_kg: m.bone_mass_kg != null ? Number(m.bone_mass_kg) : undefined,
                  })),
                  manualHistoryFull: manualMeasurements.map(m => ({
                    timestamp: m.timestamp,
                    waist_cm: m.waist_cm != null ? Number(m.waist_cm) : undefined,
                    abdomen_cm: m.abdomen_cm != null ? Number(m.abdomen_cm) : undefined,
                    hip_cm: m.hip_cm != null ? Number(m.hip_cm) : undefined,
                  })),
                });
              }}
            >
